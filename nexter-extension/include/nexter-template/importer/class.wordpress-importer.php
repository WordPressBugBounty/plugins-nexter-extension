...
<form action="<?php echo admin_url( 'admin.php?import=wordpress&amp;step=2' ); ?>" method="post">
	...
	function author_select( $n, $author ) {
		...
		else echo esc_html__( 'or assign posts to an existing user:', 'nexter-extension' );
	...
	function process_attachment( $post, $url ) {
		...
		else return new WP_Error( 'attachment_processing_error', __( 'Invalid file type', 'nexter-extension' ) );
