...
class CMB2_Hookup extends CMB2_Hookup_Base {
	...
	public function context_box_title_markup_open( $add_handle = true ) {
		...
		$toggle_button = '<button type="button" class="handlediv button-link" aria-expanded="true"><span class="screen-reader-text">' . sprintf( __( 'Toggle panel: %s','nexter-ext' ), $title ) . '</span><span class="toggle-indicator" aria-hidden="true"></span></button>';
