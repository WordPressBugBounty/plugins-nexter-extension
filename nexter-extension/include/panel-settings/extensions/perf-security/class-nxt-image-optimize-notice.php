...
class Nxt_Image_Optimize_Notice {
	...
	private function render_image_optimize_notice_html() {
		...
		echo '<div class="notice notice-info is-dismissible nxt-notice-wrap" data-notice-id="nexter_image_optimize_notice" data-nonce=\"' . esc_attr( wp_create_nonce( 'nexter_admin_nonce' ) ) . '\">';
