...
wp_register_ability(
	'nexter/get-performance-settings',
	[
...
wp_register_ability(
	'nexter/update-performance-settings',
	[
	...
	'input_schema'        => [
		...
		'properties'           => [
			...
			'values'  => [
			'type'        => 'object',
			'description' => 'Feature-specific settings to merge.'
			],
		],
		'required'             => ['feature'],
		'additionalProperties' => false,
...
function nexter_mcp_update_performance_settings(array $input): array {
	...
	return [
	'success' => true,
	'message' => "Performance feature \"{$feature_key}\" updated ({$status})."
	];
}
