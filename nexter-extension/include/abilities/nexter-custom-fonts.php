...
wp_register_ability(
	...
	'input_schema'        => [
		...
		'properties'           => [
			'enabled' => [
	'type'        => 'boolean',
	'description' => 'Enable/disable custom font upload feature.'
			],
			'fonts'   => [
				'type'        => 'array',
...
function nexter_mcp_update_custom_fonts(array $input): array {
	...
	return [
	'success' => true,
	'message' => 'Custom font settings updated.'
	];
}
